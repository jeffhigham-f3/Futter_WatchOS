...
<p align="center">
<a href="https://youtu.be/zrEz-HGwGL4" target="_blank"><img style="border: 2px solid #000; margin-top: 20px; margin-bottom: 20px; border-radius: 6px; width: 50%; @media only screen and (max-width: 600px) { width: 90%;}" src="media/flutter_watch.png"/>
</p></a>
